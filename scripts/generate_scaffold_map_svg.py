...
parts.append(f'<text x="36" y="102" font-size="13" fill="{INK_FAINT}" '
             f'font-family="ui-monospace,Consolas,monospace">Repo-wide: 4 explicit axioms &#183; 1312 functional theorems &#183; 6205 QA declarations &#183; 0 sorries &#8212; as of working tree, 2026-09-05</text>')
