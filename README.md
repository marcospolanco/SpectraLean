...
| QA theorems/lemmas | 2238, with no `sorry` or `admit` under `Scaffold/` |
...
as the regular family with the closing arithmetic verbatim), and the **Fiedler
