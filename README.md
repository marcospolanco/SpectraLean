...
| Functional theorems/lemmas (`Scaffold/Mathlib` + `Scaffold/Derived`) | 1381 — the public, consumer-facing layer `Scaffold.lean` actually imports |
| QA theorems/lemmas (`Scaffold/QA`) | 6838, with no `sorry` or `admit` under `Scaffold/` — testing infrastructure, not imported by `Scaffold.lean` |
