...
| Metric | Count |
| --- | ---: |
| QA theorem/lemma declarations | 336 |
...
| `Scaffold/QA/SpectralGraph/EffectiveResistance_QA.lean` | 17 | 0 |
...
- **QA declaration:** a theorem or lemma under `Scaffold/QA`; all 336 declarations have compiled against the current public API.
